...
def evaluate_candidate(candidate_id: str, job_description: str, pow_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prompt = PromptTemplate(
        template="""You are an expert AI technical recruiter. You MUST evaluate the candidate against the Job Description and return a fully completed JSON object. DO NOT leave any fields blank.
